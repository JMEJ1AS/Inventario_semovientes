...
public function view($id = null){
	...
	$encontrados_altas = $this->cuentaAltas($id);

	$encontrados_bajas = $this->cuentaBajas($id);

	$this->set('encontrados_altas', $encontrados_altas);

	$this->set('encontrados_bajas', $encontrados_bajas);
...
public function search(){
	...
	public function cuentaAltas($id = null){

		$encontrados = $this->Animal->find('all',
	...
	public function cuentaBajas($id = null){
