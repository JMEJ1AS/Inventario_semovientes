    ...
    <div class="span3" id="sidebar">
        ...
        <?php echo $this->element('logo'); ?>
         ...
         <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li class="active"><?php echo $this->Html->link("Ingresar animal", "../Animals/add");?></li>
               ...
               <!--<form class="form-horizontal">-->
                ...
                <div class="block">
                    ...
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-left"><i class="icon-pencil"></i> Agregar animal </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php 
                                            ...
                                            echo $this->Form->input('num_documento_alta', 
