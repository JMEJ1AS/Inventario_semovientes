...
class AnimalsController extends AppController {
	...
	public function deshacer_multiple() {
		...
		// recibir campos de formulario estatico
		//$id = $this->request->data['Animal']['id'];
		...
		if (!empty($this->data['case'])) {

			foreach($data as $value){

				$id = $this->request->data['Animal']['id_'.$i];
				...
				//$this->Animal->deleteAll(['id'=>$value]);
			...
			$this->Session->setFlash('
				...
				<div class="alert alert-success">
					...
					Los registros seleccionados fueron dados de baja satisfactoriamente.
			...
			$this->Session->setFlash('
				...
				<div class="alert alert-warning">
					...
					No disponible para efectuar acción, favor seleccionar al menos un animal.
		...
		return $this->redirect(['action'=>'baja_simultanea']);
