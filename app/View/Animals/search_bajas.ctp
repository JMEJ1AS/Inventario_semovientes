    ...
    <div class="span12" id="content">
            ...
            <div class="navbar">
                ...
                <div class="navbar-inner">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Buscar registros de baja </li>
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <?php echo $this->Form->create('Animal', array('type' => 'get', 'url' => 'search_bajas')); ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php 
                                            ...
                                            echo $this->Form->input('baja_fecha_1', 
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php 
                                            ...
                                            echo $this->Form->input('baja_fecha_2', 
