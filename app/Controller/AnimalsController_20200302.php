            ...
            $this->paginate = array(
                ...
                'conditions' =>
                    ...
                    array('AND' =>
                    	...
                    	array( 'date(Animal.fecha_ingreso) BETWEEN ? AND ?' => 
			...
			array(				
				...
				/*'conditions' =>
                    ...
                    array('AND' =>
                    	...
                    	array( 'date(Animal.fecha_baja) BETWEEN ? AND ?' => array($fecha_1, $fecha_2)),

                        //array( 'Animalspecie.nombre_comun LIKE' => '%' . $this->params['url']['animalspecie'] . '%' ),

                        //array( 'Condition.nombre LIKE' => '%' . $this->params['url']['condition'] . '%' ),
